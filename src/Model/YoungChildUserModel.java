...
public class YoungChildUserModel extends UserModel {
    public YoungChildUserModel(String userName, int age, String status, String photo, char gender, String state, Set<String> parents) {
    ...
    public void removeConnection(String connectionName) {
        for (ConnectionModel connection : this.getConnections()) {
            if (connection.getConnectionName().equals(connectionName) && !connection.getConnectionType().equals(ApplicationConstant.PARENT)) {
